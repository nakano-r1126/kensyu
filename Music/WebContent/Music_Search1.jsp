...
function search2(form){
	form.method = "post";
	form.action = "<%=request.getContextPath()%>/MusicSearch2";
	form.submit();
}
</script>
...
<li class="pre">前へ</li>
<li class="this">1</li>
<li><a href = "<%=request.getContextPath()%>/MusicSearch2">2</a></li>
<li><a href="<%=request.getContextPath()%>/MusicSearch3">3</a></li>
<li><a href="<%=request.getContextPath()%>/MusicSearch2">次へ</a></li>
</ul>
</div>
	</form>
	</body>
